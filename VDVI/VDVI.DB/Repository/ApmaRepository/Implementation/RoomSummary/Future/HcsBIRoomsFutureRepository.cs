...
namespace VDVI.Repository.ApmaRepository.Implementation
{
    public class HcsBIRoomsFutureRepository : DapperRepository<DbRoomsFuture>, IHcsBIRoomsFutureRepository
    {
        ...
        public async Task<string> BulkInsertWithProcAsync(IEnumerable<RoomsFutureDto> dto)
        {
            ...
            var queryResult = await _dbContext.Connection.QueryAsync<string>("spINSERT_hce_ReservationDashboard_Rooms_Future", new { ReservationDashboard_Rooms_History_UDT = dt }, commandType: CommandType.StoredProcedure);
