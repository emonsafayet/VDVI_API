...
namespace VDVI.Repository.ApmaRepository.Implementation
{
    public class HcsBIRevenueFutureRepository : DapperRepository<DbRevenueFuture>, IHcsBIRevenueFutureRepository
    {
        ...
        public async Task<string> BulkInsertWithProcAsync(IEnumerable<RevenueFutureDto> dto)
        {
            ...
            var queryResult = await _dbContext.Connection.QueryAsync<string>("spINSERT_hce_ReservationDashboard_Revenue_Future", new { ReservationDashboard_Revenue_History_UDT = dt }, commandType: CommandType.StoredProcedure);
