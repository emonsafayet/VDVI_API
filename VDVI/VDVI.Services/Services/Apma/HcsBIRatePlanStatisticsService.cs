...
namespace VDVI.Services.Services.Apma
{
    public class HcsBIRatePlanStatisticsService : ApmaBaseService, IHcsBIRatePlanStatisticsService
    {
        ...
        public async Task<Result<PrometheusResponse>> HcsBIRatePlanStatisticsRepositoryAsyc(DateTime StartDate, DateTime EndDate)
        {
            return await TryCatchExtension.ExecuteAndHandleErrorAsync(
                          async () =>
                          {
                              ...
                              List<RatePlanStatisticDto> ratePlanStatistics = new List<RatePlanStatisticDto>();
        ...
        private void FormatSummaryObject(List<RatePlanStatisticDto> ratePlanStatistics, List<BIRatePlanStatistic> dashboard, string propertyCode)
        {
            List<RatePlanStatisticDto> ratePlanStatistic = dashboard.Select(x => new RatePlanStatisticDto()
            {
