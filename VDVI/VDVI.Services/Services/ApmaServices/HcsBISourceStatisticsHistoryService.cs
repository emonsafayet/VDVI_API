...
{
    public class HcsBISourceStatisticsHistoryService : ApmaBaseService, IHcsBISourceStatisticsHistoryService
    {
        private readonly IHcsSourceStasticsHistoryService _hcsSourceStasticsHistoryService; 

        public HcsBISourceStatisticsHistoryService(IHcsSourceStasticsHistoryService hcsSourceStasticsHistoryService)
        {
